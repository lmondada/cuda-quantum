...
function(cudaq_read_symbol_list _file _out_var)
  # Register the re-configure dependency once per file. CMAKE_CONFIGURE_DEPENDS
  # is a directory property, and Ninja emits the listed files as outputs of the
  # re-run edge, so recording the same file twice makes the generate step fail
  # with "multiple rules generate <file>". Compare resolved paths: callers reach
  # the same list through different spellings.
