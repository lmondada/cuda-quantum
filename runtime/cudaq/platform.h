...
/// Get the default compile target configuration for a local simulator.
///
...
/// module as appropriate for a Python kernel. When @p targetConfig is
/// provided, YAML-driven pipeline placeholders are resolved from
/// @p runtimeConfig.
