...
void cnot(qubit &q, qubit &r);
void cx(qubit &q, qubit &r);
void cy(qubit &q, qubit &r);
void cz(qubit &q, qubit &r);
void ch(qubit &q, qubit &r);
void cs(qubit &q, qubit &r);
void ct(qubit &q, qubit &r);
void ccx(qubit &q, qubit &r, qubit &s);
